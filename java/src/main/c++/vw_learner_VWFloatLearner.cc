...
JNIEXPORT jfloat JNICALL Java_vw_learner_VWFloatLearner_getWeight(JNIEnv *env, jobject obj, jlong vwPtr, jint index)
{ vw* vwInstance = (vw*)vwPtr;
  return (jfloat) VW::get_weight(*vwInstance, index, 0);
}

JNIEXPORT void JNICALL Java_vw_learner_VWFloatLearner_setWeight(JNIEnv *env, jobject obj, jlong vwPtr, jint index, jfloat value)
{ vw* vwInstance = (vw*)vwPtr;
